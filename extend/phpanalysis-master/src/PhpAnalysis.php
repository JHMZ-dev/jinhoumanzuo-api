...
class PhpAnalysis
{
    ...
    //使用热门词优先模式进行消岐
    public $high_freq_priority = true;
    ...
    * @param $unit_single_word=true    合并切分后无法识别的单个中文为猜测词汇
    * @param $max_split=false           最大切分
    * @param $high_freq_priority=true  热门词优先的方式处理岐义
    * @param $optimize=true      优化结果(前面三个参数依赖这个参数)
    * @return this
    */
    public function SetOptions($unit_special_word=true, $unit_single_word=true, $max_split=false, $high_freq_priority=true, $optimize=true)
    {
     ...
     */
    public function Exec( $return = true ,  $GetResult = 1 )
    {
